...
import com.web.seek.oauth.CustomOAuth2Provider;

import static com.web.seek.domain.enums.SocialType.FACEBOOK;
import static com.web.seek.domain.enums.SocialType.GOOGLE;
import static com.web.seek.domain.enums.SocialType.KAKAO;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeRequests()
                .antMatchers("/", "/oauth2/**", "/login/**", "/css/**", "/images/**", "/js/**", "/h2-console/**").permitAll()
